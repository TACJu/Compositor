...
_PREDEFINED_SPLITS_PARTIMAGENET_SEMANTIC = {
    "partimagenet_train": (
        "PartImageNet/images/train",
        "PartImageNet/annotations/train",
        "PartImageNet/annotations/train_whole",
    ),
    "partimagenet_val": (
        "PartImageNet/images/val/",
        "PartImageNet/annotations/val",
        "PartImageNet/annotations/val_whole",
    ),
    "partimagenet_test": (
        "PartImageNet/images/test",
        "PartImageNet/annotations/test",
        "PartImageNet/annotations/test_whole",
    )
}

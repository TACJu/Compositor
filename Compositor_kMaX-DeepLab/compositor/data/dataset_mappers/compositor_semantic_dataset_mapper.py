...
class CompositorSemanticDatasetMapper:
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            ignore_part_label: the part label that is ignored to evaluation
            ignore_object_label: the object label that is ignored to evaluation
        """
    ...
    def __call__(self, dataset_dict):
        ...
        """
        assert self.is_train, "MaskFormerPartSemanticDatasetMapper should only be used for training!"
